...
subtitle: Comment ? Pourquoi ? Retours d'expérience
author: Arnaud Bailly - ![](https://upload.wikimedia.org/wikipedia/commons/7/7a/Bluesky_Logo.svg){ width=40px } - @panzksoft.net
date: Nantes JUG - 2026-04-29
...
* _(en option)_ Retour d'expérience - Amaru
* Conclusion
...
![Jack-of-all-Trades](/images/jack-of-all-trades.jpg)
...
![[Before GitHub](https://lucumr.pocoo.org/2026/4/28/before-github/)](/images/2026-04-28-armin-ronacher-blog.png)

::: notes

article de blog intéressant sur GitHub, ce qu'il a permis, ce qu'il y avait avant, ce qu'il y aura après

* la fonction d'archivage est essentielle
* GH a diminué le coût d'entrée dans l'OSS
* GH A permis de dépendre de projets de plus en plus petits -> accroit la surface des dépendances
...
* Des alternatives auto-hébergées et/ou open-source émergent
  * [llama.cpp](https://github.com/ggml-org/llama.cpp), [HuggingFace](https://huggingface.co), [vLLM](https://github.com/vllm-project/vllm)
