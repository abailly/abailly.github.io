...
* I noticed there were a lot of questions on the type `List a` on the `#beginners` channel in `elm-lang`'s Slack
* [Robert "Uncle Bob" Martin ](http://blog.cleancoder.com/uncle-bob/2016/05/01/TypeWars.html) on test coverage and types:

    > You don’t need static type checking if you have 100% unit test coverage.

* [Making Impossible States Impossible](https://www.youtube.com/watch?v=IcgmSRJHu_8)
* Makign *Business Domains* more formal and executable
